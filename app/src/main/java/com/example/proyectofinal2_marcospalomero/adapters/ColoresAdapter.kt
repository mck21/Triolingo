...
class ColoresAdapter(private val lista: ArrayList<Traduccion>) :
    RecyclerView.Adapter<ColoresAdapter.MiViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType: Int): MiViewHolder {
        val view = LayoutInflater.from(viewGroup.context)
            .inflate(R.layout.colores_lista, viewGroup, false)
    ...
    override fun onBindViewHolder(viewHolder: MiViewHolder, position: Int) {
        ...
        // Si ya esta en favoritos, el corazon estara relleno y al clickar saldra el snackbar
        ...
        viewHolder.heartImage.setOnClickListener {
            //añadir a favoritos y rellenar corazon
            if (cont == 0) {
                viewHolder.heartImage.setImageResource(R.drawable.filledheart)
                cont++
